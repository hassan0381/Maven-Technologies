...
const FAQ_Item = (item:FAQItem) => {
  ...
  return (    
    <React.Fragment>      
      <div className="faqspage_faqsitem_container" 
        onClick={() => handleToggle()}
        style={toggled?{backgroundColor:"rgb(255,255,255)"}:{backgroundColor:"rgb(0, 0, 0, 0.1)"}}>
                    ...
                    (
                      <div className="grid grid-cols-12 gap-2">
                        ...
                        <div className="col-span-4 ">
                          <img src={item.image} alt={item.question} className="faqspage_faqsitem_answerimage" />
                        </div>
                      </div>
                    ):
                    (
...
FAQ_Item.defaultProps = {
  ...
  sub_title: "General",
  short_answer: "42",
  long_answer: "42 is the answer to the ultimate question of life, the universe, and everything.",
